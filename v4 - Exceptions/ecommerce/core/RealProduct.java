...
public class RealProduct extends AbstractProduct {
    ...
    public void updateShoppingCart(ShoppingCart shoppingCart,
    				int selectedQuantityChange){
        shoppingCart.setProductsTotalPrice(shoppingCart.getProductsTotalPrice()
        				+ (getPrice() * selectedQuantityChange));
        shoppingCart.setShippingCost(shoppingCart.getShippingCost()
        			+ (getWeight() * selectedQuantityChange) * UNIT_SHIPPING_COST);
    }
}
